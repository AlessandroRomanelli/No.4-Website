        ...
        init: function(o) {
            ...
            return e || !(o.browser.length > 0) || e && this.length ? (a.optionCheck.call(this, o) && t("." + o.overlayClass).length <= 0 && a.addOverlay.call(this, o), o.loading && t("." + o.loadingClass).length <= 0 && a.addLoading.call(this, o), this.each(function() {
                ...
                s.data(n) || (o = t.extend({}, o), s.data(n, {
                    options: o
                }), o.timeout && a.addTimer.call(e), o.onLoadEvent && (i ? (a.settings.timer && clearTimeout(a.settings.timer), a.in.call(e)) : l.on("load." + n, function() {
...
function toggleSound() {
    ...
    "true" == sessionStorage.isPaused ? (sessionStorage.musicTime && parseFloat(sessionStorage.musicTime) < 150 ? e.currentTime = parseFloat(sessionStorage.musicTime) : e.currentTime = 0, e.play(), e.volume = .01, $("#bgVideo").data("vide").getVideoObject().volume = .015, $("#volumeControl").attr("src", "img/icons/vol3.svg"), sessionStorage.isPaused = "false") : (sessionStorage.musicTime = e.currentTime, e.pause(), $("#bgVideo").data("vide").getVideoObject().volume = 0, $("#volumeControl").attr("src", "img/icons/vol0.svg"), sessionStorage.isPaused = "true")
}

function collapseCard(e) {
    $(e).addClass("collapsed"), $(e).next().children().last().collapse("hide")
}

function toggleButton(e) {
    $(e).children().first().hide(), $(e).children().last().toggleClass("arrowUp arrowDown")
}

function getBritishTime(e) {
    var o = new Intl.DateTimeFormat([], {
        timeZone: "Europe/London",
        hour: "numeric",
        minute: "numeric"
    });
    $(e).text(o.format(new Date))
}
$(document).ready(function() {
    if ($(".animsition").animsition({
    ...
    }), $(".weapon-pop").popover(), $(".popover-dismiss").popover(), $("#medals img").hover(function() {
        for (var e = $("#medals").children(), o = $.inArray($(this).parent()[0], e), i = e.length, t = 0; t < i; t++) {
            var n = {
                "z-index": Math.round(0 - Math.abs(t - o) + i / 2) + 10
            };
            e.eq(t).children().css(n)
        }
    }), $("#operations-cards a").blur(function() {
        setTimeout(collapseCard, 300, this)
    }), $("#navbarNav ul li a").click(function(e) {
        sessionStorage.musicTime = document.getElementById("player").currentTime + 1.5
    })
});
